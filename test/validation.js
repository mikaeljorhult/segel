...
test.beforeEach(function (t) {
  t.context = {
    bookings: [
      {id: 1, resource: 1, start: new Date(2017, 0, 1, 10) / 1000, end: new Date(2017, 0, 1, 11) / 1000},
      {id: 2, resource: 1, start: new Date(2017, 0, 1, 17) / 1000, end: new Date(2017, 0, 1, 19) / 1000},
      {id: 3, resource: 2, start: new Date(2017, 0, 1, 11) / 1000, end: new Date(2017, 0, 1, 13) / 1000}
    ]
  };
});
